 ...
 */
public abstract class SinaShareActivity extends TitleActivity implements
...
//		bmp.recycle();
			...
			if (mWeiboShareAPI.isWeiboAppInstalled()) {
				...
				if (mAccessToken.isSessionValid()) {// Token可用
					...
					mSsoHandler.authorize(new WeiboAuthListener() {
						 ...
						 * {@link com.sina.weibo.sdk.auth.sso.SsoHandler#authorizeCallBack}
						...
						public void onComplete(Bundle values) {
							...
							if (mAccessToken.isSessionValid()) {
								...
								AccessTokenKeeper.writeAccessToken(
										com.emiancang.emiancang.base.SinaShareActivity.this, mAccessToken);
								Toast.makeText(
										com.emiancang.emiancang.base.SinaShareActivity.this,
								...
								Toast.makeText(com.emiancang.emiancang.base.SinaShareActivity.this, message,
										Toast.LENGTH_LONG).show();
							}
						}
						...
						public void onCancel() {
							Toast.makeText(com.emiancang.emiancang.base.SinaShareActivity.this,
				...
				Toast.makeText(com.emiancang.emiancang.base.SinaShareActivity.this, "没有安装微博",
						Toast.LENGTH_LONG).show();
			}
		} catch (WeiboShareException e) {
			e.printStackTrace();
			 Toast.makeText(com.emiancang.emiancang.base.SinaShareActivity.this, e.getMessage(),
			 Toast.LENGTH_LONG).show();
		}
	}
	...
	private void sendMultiMessage(TextObject textObject,
		...
		mWeiboShareAPI.sendRequest(com.emiancang.emiancang.base.SinaShareActivity.this,request);
	}
