            ...
            case PushConsts.GET_CLIENTID:
                ...
                switch (i) {
                    ...
                    case PushConsts.SETTAG_ERROR_COUNT:
                        errortext = "设置标签失败, tag数量过大, 最大不能超过200个";
                        break;

                    case PushConsts.SETTAG_ERROR_FREQUENCY:
                        errortext = "设置标签失败, 频率过快, 两次间隔应大于1s";
                        break;

                    case PushConsts.SETTAG_ERROR_REPEAT:
                        errortext = "设置标签失败, 标签重复";
                        break;

                    case PushConsts.SETTAG_ERROR_UNBIND:
                        errortext = "设置标签失败, 服务未初始化成功";
                        break;

                    case PushConsts.SETTAG_ERROR_EXCEPTION:
                        errortext = "设置标签失败, 未知异常";
                        break;

                    case PushConsts.SETTAG_ERROR_NULL:
                        errortext = "设置标签失败, tag 为空";
                        break;
                    ...
                    case PushConsts.SETTAG_IN_BLACKLIST:
                        errortext = "该应用已经在黑名单中,请联系售后支持!";
                        break;

                    case PushConsts.SETTAG_NUM_EXCEED:
                        errortext = "已存 tag 超过限制";
                        break;
