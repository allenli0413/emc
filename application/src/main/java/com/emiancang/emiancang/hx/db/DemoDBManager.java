package com.emiancang.emiancang.hx.db;
    ...
    synchronized public Map<String, EaseUser> getContactList() {
        ...
        if (db.isOpen()) {
            ...
            while (cursor.moveToNext()) {
                ...
                if (username.equals(com.emiancang.emiancang.hx.Constant.NEW_FRIENDS_USERNAME) || username.equals(com.emiancang.emiancang.hx.Constant.GROUP_USERNAME)
                        || username.equals(com.emiancang.emiancang.hx.Constant.CHAT_ROOM)|| username.equals(com.emiancang.emiancang.hx.Constant.CHAT_ROBOT)) {
