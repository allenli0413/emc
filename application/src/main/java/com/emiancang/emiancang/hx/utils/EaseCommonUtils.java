 ...
 */
package com.emiancang.emiancang.hx.utils;
...
public class EaseCommonUtils {
	...
	public static EMMessage createExpressionMessage(String toChatUsername, String expressioName, String identityCode) {
		...
		if (identityCode != null) {
			message.setAttribute(com.emiancang.emiancang.hx.Constant.MESSAGE_ATTR_EXPRESSION_ID, identityCode);
		}
		message.setAttribute(com.emiancang.emiancang.hx.Constant.MESSAGE_ATTR_IS_BIG_EXPRESSION, true);
		return message;
	}
	...
	public static String getMessageDigest(EMMessage message, Context context) {
		...
		case TXT: // 文本消息
			...
			if (message.getBooleanAttribute(com.emiancang.emiancang.hx.Constant.MESSAGE_ATTR_IS_VOICE_CALL, false)) {
				digest = getString(context, R.string.voice_call) + txtBody.getMessage();
			} else if (message.getBooleanAttribute(com.emiancang.emiancang.hx.Constant.MESSAGE_ATTR_IS_VIDEO_CALL, false)) {
				digest = getString(context, R.string.video_call) + txtBody.getMessage();
			} else if (message.getBooleanAttribute(com.emiancang.emiancang.hx.Constant.MESSAGE_ATTR_IS_BIG_EXPRESSION, false)) {
	...
	public static EMConversationType getConversationType(int chatType) {
		if (chatType == com.emiancang.emiancang.hx.Constant.CHATTYPE_SINGLE) {
			return EMConversationType.Chat;
		} else if (chatType == com.emiancang.emiancang.hx.Constant.CHATTYPE_GROUP) {
