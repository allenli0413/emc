...
public class CottonRecommendAdapter extends BaseAdapter {

    Context mContext;
    List<CottonRecommendModel> list;

    public CottonRecommendAdapter(Context mContext, List<CottonRecommendModel> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.adapter_cotton_recommend,
                    parent, false);
