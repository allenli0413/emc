...
public class FindMoneyDetailStatusAdapter extends BaseAdapter {

    List<FindMoneyDetailStatusModel.EfxkkList> list = new ArrayList<>();

    public FindMoneyDetailStatusAdapter(List<FindMoneyDetailStatusModel.EfxkkList> efxkkList) {
        list = efxkkList;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        FindMoneyDetailStatusModel.EfxkkList item = list.get(position);
