...
import com.emiancang.emiancang.main.home.logisticsquery.model.MineLogisticsQueryModel;
...
public class MineLogisticsQueryAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.ll_adapter_logistics_query_head.setVisibility(View.GONE);
        viewHolder.view_adapter_logistics_query_split.setVisibility(View.GONE);
