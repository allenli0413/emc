...
public class RedPaperCottonProductDetailGetModel {
    /**
     * 6.26.查询产品详情信息

     调用接口：/home/ getCompanyDetails2
     请求方式：get
     参数列表：
     参数名称	参数命名	说明	举例
     产品id	productId	int	8443
    ...
    public String getHyJysjCkqy() {
        return hyJysjCkqy;
    }

    public void setHyJysjCkqy(String hyJysjCkqy) {
        this.hyJysjCkqy = hyJysjCkqy;
    }
