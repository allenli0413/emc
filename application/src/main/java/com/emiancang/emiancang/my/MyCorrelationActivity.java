...
public class MyCorrelationActivity extends TitleActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = View.inflate(getActivity(), R.layout.activity_correlation, null);
        setContentView(view);
    ...
    private void initHead() {
        ...
        getHeadBar().setCenterTitle("关于我们", getResources().getColor(R.color.white));
    }
