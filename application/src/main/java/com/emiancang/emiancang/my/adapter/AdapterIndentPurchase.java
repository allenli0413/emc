 ...
 * @date 16-9-1 下午3:17
 */
public class AdapterIndentPurchase extends BaseAdapter {

    private List<OrderInfo> list = new ArrayList<>();

    public AdapterIndentPurchase() {
    }
    ...
    public View getView(int position, View convertView, @NotNull ViewGroup parent) {
        convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_indent_purchase, parent, false);
