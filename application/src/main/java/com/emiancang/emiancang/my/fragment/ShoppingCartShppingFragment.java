...
import com.emiancang.emiancang.my.adapter.AdapterShoppingCartSalesman;
...
public class ShoppingCartShppingFragment extends TitleFragment {
    ...
    private AdapterShoppingCartSalesman mAdapter = null;
    ...
    public void onEventMainThread(ShoppingCartSalesmanTransfer shoppingCartSalesmanTransfer){
        refresh(mlon+"", mlat+"");
    }

    private void initView() {
        mAdapter = new AdapterShoppingCartSalesman(getActivity());
