package com.emiancang.emiancang.sina;
...
//		bmp.recycle();
	...
	private void sendMessage(final TextObject textObject,
		...
		try {
						...
						public void onComplete(Bundle values) {
							...
							if (mAccessToken.isSessionValid()) {
								...
								AccessTokenKeeper.writeAccessToken(
										SinaShareActivity.this, mAccessToken);
								Toast.makeText(
								...
								Toast.makeText(SinaShareActivity.this, message,
										Toast.LENGTH_LONG).show();
							}
						}
			...
			e.printStackTrace();
			 Toast.makeText(SinaShareActivity.this, e.getMessage(),
			 Toast.LENGTH_LONG).show();
		}
	}
